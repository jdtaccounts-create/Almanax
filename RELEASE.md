...
- Dépôt local : `D:\GitHub\Almanax`
- Dépôt GitHub : `jdtaccounts-create/Almanax`
- Identifiant Tauri : `fr.moufle.almanax`
- Clé privée updater locale : `C:\Users\Moufle\.tauri\updater-keys\almanax.key`
- Clé publique updater locale : `C:\Users\Moufle\.tauri\updater-keys\almanax.key.pub`
...
$env:TAURI_SIGNING_PRIVATE_KEY = Get-Content -Raw "C:\Users\Moufle\.tauri\updater-keys\almanax.key"
npm run tauri -- build
